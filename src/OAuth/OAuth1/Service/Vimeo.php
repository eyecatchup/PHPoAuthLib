<?php
/**
 * OAuth2 service implementation for Vimeo.
 *
 * PHP version 5.4
 *
 * @category   OAuth
...
class Vimeo extends AbstractService
{
    ...
    {
        return new Uri('https://vimeo.com/oauth/request_token');
    }
    ...
    {
        return new Uri('https://vimeo.com/oauth/authorize');
    }
    ...
    {
        return new Uri('https://vimeo.com/oauth/access_token');
    }
